...
key = 'CEA73D8D544B23CA84E15EC26936ED62'
...
index_schema = './mix-project-index.json'
...
if __name__ == '__main__':
    ...
    gs = GetSampleClient()
    samples_data = gs.get_samples(project_id="20523")
    batch_upload = batch_upload_json_data_to_index(samples_data, search_client)
